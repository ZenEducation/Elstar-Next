...
const authDemoRoute = [
  {
    ...
    component: dynamic(() => import("views/auth-demo/SignIn/SignInSimple")),
  ...
  },
  {
    ...
    component: dynamic(() => import("views/auth-demo/SignIn/SignInSide")),
    authority: [ADMIN, USER],
    meta: {
      layout: "blank",
      pageContainerType: "gutterless",
  ...
  },
  {
    ...
    component: dynamic(() => import("views/auth-demo/SignIn/SignInCover")),
    authority: [ADMIN, USER],
    meta: {
      layout: "blank",
      pageContainerType: "gutterless",
  ...
  },
  {
    ...
    component: dynamic(() => import("views/auth-demo/SignUp/SignUpSimple")),
    authority: [ADMIN, USER],
    meta: {
      layout: "blank",
      pageContainerType: "gutterless",
  ...
  },
  {
    ...
    component: dynamic(() => import("views/auth-demo/SignUp/SignUpSide")),
    authority: [ADMIN, USER],
    meta: {
      layout: "blank",
      pageContainerType: "gutterless",
  ...
  },
  {
    ...
    component: dynamic(() => import("views/auth-demo/SignUp/SignUpCover")),
    authority: [ADMIN, USER],
    meta: {
      layout: "blank",
      pageContainerType: "gutterless",

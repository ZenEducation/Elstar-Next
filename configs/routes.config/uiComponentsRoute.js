...
const uiComponentsRoute = [
  {
    ...
    component: dynamic(() => import("components/ui-components/common/Button")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.common.grid",
    path: `${UI_COMPONENTS_PREFIX_PATH}/grid`,
    component: dynamic(() => import("components/ui-components/common/Grid")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.common.typography",
    path: `${UI_COMPONENTS_PREFIX_PATH}/typography`,
    component: dynamic(() => import("components/ui-components/common/Typography")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.common.icons",
    path: `${UI_COMPONENTS_PREFIX_PATH}/icons`,
    component: dynamic(() => import("components/ui-components/common/Icons")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.feedback.alert",
    path: `${UI_COMPONENTS_PREFIX_PATH}/alert`,
    component: dynamic(() => import("components/ui-components/feedback/Alert")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.feedback.dialog",
    path: `${UI_COMPONENTS_PREFIX_PATH}/dialog`,
    component: dynamic(() => import("components/ui-components/feedback/Dialog")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.feedback.drawer",
    path: `${UI_COMPONENTS_PREFIX_PATH}/drawer`,
    component: dynamic(() => import("components/ui-components/feedback/Drawer")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.feedback.progress",
    path: `${UI_COMPONENTS_PREFIX_PATH}/progress`,
    component: dynamic(() => import("components/ui-components/feedback/Progress")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.feedback.skeleton",
    path: `${UI_COMPONENTS_PREFIX_PATH}/skeleton`,
    component: dynamic(() => import("components/ui-components/feedback/Skeleton")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.feedback.spinner",
    path: `${UI_COMPONENTS_PREFIX_PATH}/spinner`,
    component: dynamic(() => import("components/ui-components/feedback/Spinner")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.feedback.toast",
    path: `${UI_COMPONENTS_PREFIX_PATH}/toast`,
    component: dynamic(() => import("components/ui-components/feedback/Toast")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.dataDisplay.avatar",
    path: `${UI_COMPONENTS_PREFIX_PATH}/avatar`,
    component: dynamic(() => import("components/ui-components/data-display/Avatar")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.dataDisplay.badge",
    path: `${UI_COMPONENTS_PREFIX_PATH}/badge`,
    component: dynamic(() => import("components/ui-components/data-display/Badge")),
    authority: [ADMIN, USER],
  },
  {
    ...
    component: dynamic(() =>
      import("components/ui-components/data-display/Calendar")
    ),
    authority: [ADMIN, USER],
  },
  {
    ...
    component: dynamic(() => import("components/ui-components/data-display/Cards")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.dataDisplay.table",
    path: `${UI_COMPONENTS_PREFIX_PATH}/table`,
    component: dynamic(() => import("components/ui-components/data-display/Table")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.dataDisplay.tag",
    path: `${UI_COMPONENTS_PREFIX_PATH}/tag`,
    component: dynamic(() => import("components/ui-components/data-display/Tag")),
    authority: [ADMIN, USER],
  },
  {
    ...
    component: dynamic(() =>
      import("components/ui-components/data-display/Timeline")
    ),
    authority: [ADMIN, USER],
  },
  {
    ...
    component: dynamic(() =>
      import("components/ui-components/data-display/Tooltip")
    ),
    authority: [ADMIN, USER],
  },
  {
    ...
    component: dynamic(() => import("components/ui-components/forms/Checkbox")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.datePicker",
    path: `${UI_COMPONENTS_PREFIX_PATH}/date-picker`,
    component: dynamic(() => import("components/ui-components/forms/DatePicker")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.formControl",
    path: `${UI_COMPONENTS_PREFIX_PATH}/form-control`,
    component: dynamic(() => import("components/ui-components/forms/FormControl")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.input",
    path: `${UI_COMPONENTS_PREFIX_PATH}/input`,
    component: dynamic(() => import("components/ui-components/forms/Input")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.inputGroup",
    path: `${UI_COMPONENTS_PREFIX_PATH}/input-group`,
    component: dynamic(() => import("components/ui-components/forms/InputGroup")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.radio",
    path: `${UI_COMPONENTS_PREFIX_PATH}/radio`,
    component: dynamic(() => import("components/ui-components/forms/Radio")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.segment",
    path: `${UI_COMPONENTS_PREFIX_PATH}/segment`,
    component: dynamic(() => import("components/ui-components/forms/Segment")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.select",
    path: `${UI_COMPONENTS_PREFIX_PATH}/select`,
    component: dynamic(() => import("components/ui-components/forms/Select")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.switcher",
    path: `${UI_COMPONENTS_PREFIX_PATH}/switcher`,
    component: dynamic(() => import("components/ui-components/forms/Switcher")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.timeInput",
    path: `${UI_COMPONENTS_PREFIX_PATH}/time-input`,
    component: dynamic(() => import("components/ui-components/forms/TimeInput")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.upload",
    path: `${UI_COMPONENTS_PREFIX_PATH}/upload`,
    component: dynamic(() => import("components/ui-components/forms/Upload")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.forms.upload",
  ...
  },
  {
    ...
    component: dynamic(() => import("components/ui-components/navigation/Dropdown")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.navigation.menu",
    path: `${UI_COMPONENTS_PREFIX_PATH}/menu`,
    component: dynamic(() => import("components/ui-components/navigation/Menu")),
    authority: [ADMIN, USER],
  },
  {
    ...
    component: dynamic(() =>
      import("components/ui-components/navigation/Pagination")
    ),
    authority: [ADMIN, USER],
  },
  {
    ...
    component: dynamic(() => import("components/ui-components/navigation/Steps")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.navigation.tabs",
    path: `${UI_COMPONENTS_PREFIX_PATH}/tabs`,
    component: dynamic(() => import("components/ui-components/navigation/Tabs")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.graph.charts",
    path: `${UI_COMPONENTS_PREFIX_PATH}/graph/charts`,
    component: dynamic(() => import("components/ui-components/graph/Charts")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.graph.maps",
    path: `${UI_COMPONENTS_PREFIX_PATH}/graph/maps`,
    component: dynamic(() => import("components/ui-components/graph/Maps")),
    authority: [ADMIN, USER],
  },
];

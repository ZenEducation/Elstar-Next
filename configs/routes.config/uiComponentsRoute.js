...
const uiComponentsRoute = [
  ...
  },
  {
    ...
    component: dynamic(() => import("views/ui-components/data-display/Cards")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.dataDisplay.table",
    path: `${UI_COMPONENTS_PREFIX_PATH}/table`,
    component: dynamic(() => import("views/ui-components/data-display/Table")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.dataDisplay.tag",
    path: `${UI_COMPONENTS_PREFIX_PATH}/tag`,
    component: dynamic(() => import("views/ui-components/data-display/Tag")),
    authority: [ADMIN, USER],
  },
  {
  ...
  },
  {
    ...
    component: dynamic(() => import("views/ui-components/navigation/Dropdown")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.navigation.menu",
    path: `${UI_COMPONENTS_PREFIX_PATH}/menu`,
    component: dynamic(() => import("views/ui-components/navigation/Menu")),
    authority: [ADMIN, USER],
  },
  {
  ...
  },
  {
    ...
    component: dynamic(() => import("views/ui-components/navigation/Steps")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.navigation.tabs",
    path: `${UI_COMPONENTS_PREFIX_PATH}/tabs`,
    component: dynamic(() => import("views/ui-components/navigation/Tabs")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.graph.charts",
    path: `${UI_COMPONENTS_PREFIX_PATH}/graph/charts`,
    component: dynamic(() => import("views/ui-components/graph/Charts")),
    authority: [ADMIN, USER],
  },
  {
    key: "uiComponent.graph.maps",
    path: `${UI_COMPONENTS_PREFIX_PATH}/graph/maps`,
    component: dynamic(() => import("views/ui-components/graph/Maps")),
    authority: [ADMIN, USER],
  },
];
